...
namespace QuizBuilder.Controllers
{
    ...
    public class TeacherController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Subjects.Include(s => s.Teacher);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Password,TeacherId")] Subject subject)
        {
            ...
            ViewData["TeacherId"] = new SelectList(_context.Users, "Id", "Id", subject.TeacherId);
            return View(subject);
        }
